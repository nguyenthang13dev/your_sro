...
import { searchQLPage_ApiDataType } from "@/interface/QLPage_Api/QLPage_Api";
import { qLPage_ApiService } from "@/services/QLPage_Api/QLPage_Api.service";
import { downloadFileFromBase64 } from "@/utils/fileDownload";

interface SearchProps {
    onFinish: ((values: searchQLPage_ApiDataType) => void) | undefined;
}
const Search: React.FC<SearchProps> = ({ onFinish }) => {
    const handleExport = async () => {
        const excelBase64 = await qLPage_ApiService.exportExcel();
        downloadFileFromBase64(excelBase64.data, "Danh sách QLPage_Api.xlsx");
    };
