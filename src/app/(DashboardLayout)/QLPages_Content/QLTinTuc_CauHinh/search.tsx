...
import { searchQLTinTuc_CauHinhDataType } from "@/interface/QLTinTuc_CauHinh/QLTinTuc_CauHinh";
import { qLTinTuc_CauHinhService } from "@/services/QLTinTuc_CauHinh/QLTinTuc_CauHinh.service";
import { downloadFileFromBase64 } from "@/utils/fileDownload";

interface SearchProps {
    onFinish: ((values: searchQLTinTuc_CauHinhDataType) => void) | undefined;
}
const Search: React.FC<SearchProps> = ({ onFinish }) => {
    const handleExport = async () => {
        const excelBase64 = await qLTinTuc_CauHinhService.exportExcel();
        downloadFileFromBase64(excelBase64.data, 'Danh sách QLTinTuc_CauHinh.xlsx')
    };
