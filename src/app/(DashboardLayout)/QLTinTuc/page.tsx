...
const Page: React.FC = () => {
    ...
    const tableColumns: TableProps<tableQLTinTucDataType>["columns"] = [
        ...
        },
        {
            ...
            width: "15%",
            render: (_: any, record: tableQLTinTucDataType) => {
                return record.chuyenMucNames &&
                    record.chuyenMucNames.length > 0 ? (
                    <div
        ...
        async (searchDataOverride?: searchQLTinTucData) => {
            ...
            try {
                ...
                if (response != null && response.data != null) {
                    ...
                    const items: tableQLTinTucDataType[] = data.items;
                    setListqlTinTuc(items);
                    setDataPage({
        ...
        const content = `
            <div>
                ...
                <p><strong>Ngày phát hành:</strong> ${
                    record.publicDate
                        ? new Date(record.publicDate).toLocaleDateString(
                              "vi-VN",
                          )
                        : ""
                }</p>
    ...
    return (
        <>
            ...
            >
                ...
                <div>
                    ...
                    <CreateOrUpdate
                        ...
                        onClose={handleClose}
                        qlTinTuc={currentTinTuc}
                        istintuc={currentloaiTinTuc}
            ...
            <ConfigReaction
                ...
                data={currentTinTuc!}
                onClose={() => setIsOpenReaction(false)}
                onSucces={() => {
                    handleGetListqlTinTuc();
                }}
            />
